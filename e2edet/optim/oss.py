...
from e2edet.utils.params import (
    ParamBucket,
    calc_grad_norm,
...
class OSS(torch.optim.Optimizer):
    ...
    def __init__(
        ...
        **default: Any,
        ...
        if not is_dist_avail_and_initialized():
            raise RuntimeError("OSS should be used with distributed training!")
        ...
        self.__per_device_params: Dict[
            torch.device, List[List[torch.nn.Parameter]]
    ...
    @property
    def _per_device_params(self) -> Dict[torch.device, List[List[torch.nn.Parameter]]]:
