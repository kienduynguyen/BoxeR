...
from .box3d_transformer import Box3dTransformer
from e2edet.utils.general import get_clones, get_activation_fn
...
def build_transformer(config):
    ...
    if arch == "transformer":
        return Transformer(
            ...
            return_intermediate_dec=params["return_intermediate_dec"],
            pass_pos_and_query=params["pass_pos_and_query"],
        )
    elif arch == "box_transformer":
        ...
        raise ValueError(
            f"{arch} is not supported (choose transformer|box_transformer|box3d_transformer)!"
        )
